...
class SteamAPI {
  ...
  getAppList() {
    return new Promise(async (resolve, reject) => {
      const json = await fetch(`${this.baseURL}/ISteamApps/GetAppList/v2`, this.headers).catch(reject);
  ...
  getGameAchievements(app) {
    return new Promise(async (resolve, reject) => {
      ...
      const json = await fetch(`${this.baseURL}/ISteamUserStats/GetGlobalAchievementPercentagesForApp/v2?gameid=${app}`, this.headers).catch(reject);
  ...
  getGameNews(app) {
    return new Promise(async (resolve, reject) => {
      if (!appReg.test(app)) return reject('no appid provided');
      const json = await fetch(`${this.baseURL}/ISteamNews/GetNewsForApp/v2?appid=${app}`, this.headers).catch(reject);
  ...
  getGamePlayers(app) {
    return new Promise(async (resolve, reject) => {
      if (!appReg.test(app)) return reject('no appid provided');
      const json = await fetch(`${this.baseURL}/ISteamUserStats/GetNumberOfCurrentPlayers/v1?appid=${app}`, this.headers).catch(reject);
  ...
  getGameSchema(app) {
    return new Promise(async (resolve, reject) => {
      if (!appReg.test(app)) return reject('no appid provided');
      const json = await fetch(`${this.baseURL}/ISteamUserStats/GetSchemaForGame/v2?key=${this.key}&appid=${app}`, this.headers).catch(reject);
  ...
  getServers(ip) {
    return new Promise(async (resolve, reject) => {
      ...
      const json = await fetch(`${this.baseURL}/ISteamApps/GetServersAtAddress/v1?addr=${ip}`, this.headers).catch(reject);
  ...
  getUserAchievements(id, app) {
    return new Promise(async (resolve, reject) => {
      ...
      if (!appReg.test(app)) return reject('no appid provided');
      const json = await fetch(`${this.baseURL}/ISteamUserStats/GetPlayerAchievements/v1?key=${this.key}&steamid=${id}&appid=${app}`, this.headers).catch(reject);
  ...
  getUserBadges(id) {
    return new Promise(async (resolve, reject) => {
      ...
      const json = await fetch(`${this.baseURL}/IPlayerService/GetBadges/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
  ...
  getUserBans(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/ISteamUser/GetPlayerBans/v1?key=${this.key}&steamids=${id}`, this.headers).catch(reject);
  ...
  getUserFriends(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/ISteamUser/GetFriendList/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
  ...
  getUserGroups(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/ISteamUser/GetUserGroupList/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
  ...
  getUserLevel(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/IPlayerService/GetSteamLevel/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
  ...
  getUserOwnedGames(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/IPlayerService/GetOwnedGames/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
  ...
  getUserRecentGames(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/IPlayerService/GetRecentlyPlayedGames/v1?key=${this.key}&steamid=${id}`, this.headers).catch(reject);
      resolve(json.response.games.map(game => ({
        appID: game.appid,
  ...
  getUserServers(hide = false, key = this.key) {
    return new Promise(async (resolve, reject) => {
      const json = await fetch(`${this.baseURL}/IGameServersService/GetAccountList/v1?key=${key}`, this.headers).catch(reject);
  ...
  getUserStats(id, app) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no user id provided');
      if (!appReg.test(app)) return reject('no appid provided');
      const json = await fetch(`${this.baseURL}/ISteamUserStats/GetUserStatsForGame/v2?key=${this.key}&steamid=${id}&appid=${app}`, this.headers).catch(reject);
  ...
  getUserSummary(id) {
    return new Promise(async (resolve, reject) => {
      if (!idReg.test(id)) return reject('no id provided');
      const json = await fetch(`${this.baseURL}/ISteamUser/GetPlayerSummaries/v2?key=${this.key}&steamids=${id}`, this.headers).catch(reject);
